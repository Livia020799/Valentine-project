...
function handleNoClick() {
  noCount++;
  yesButtonSize +=  noCount *  0.5 +  0.2; // Increase the size of the "Yes" button by  20 pixels
  updateApp();
  //var yesButtonElement = document.getElementById('yesButton'); // Replace 'yourButtonId' with the actual ID of your "Yes" button
  //if (yesButtonElement) {
    //yesButtonElement.style.fontSize = yesButtonSize + 'px'; // Update the font size of the button
  //} else {
    //console.error("No element with id 'yesButton' found.");
  //}
